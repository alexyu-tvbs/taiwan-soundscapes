...
framework-specific fixtures for composability and reuse. **Works equally well for pure API testing
...
- **Backend-first mentality**: Most utilities work without a browser - pure API/service testing is a
...
**Note**: 6 of 9 utilities work without a browser. Only 3 are UI-specific (network-recorder,
intercept-network-call, network-error-monitor).
