...
processed: {project-root}/\_bmad/bmm/workflows/document-project/workflow.yaml</critical>
...
- Or run `workflow-init` to create a workflow path and get guided next steps {{/if}} </output>
