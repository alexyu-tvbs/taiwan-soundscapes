...
1. Get the last element from the `stepsCompleted` array (this is the filename of the last completed
   step, e.g., "step-03-success.md")
...
already completed the PRD workflow for {{project_name}}.
...
**If workflow not complete:** "Welcome back {{user_name}}! I'm resuming our PRD collaboration for
{{project_name}}.
...
fully the {nextStepFile} to resume the workflow.
