...
description:
  'Holistic Quality Assessment - Assess PRD as cohesive, compelling document - is it a good PRD?'
...
Assess the PRD as a cohesive, compelling document - evaluating document flow, dual audience
effectiveness (humans and LLMs), BMAD PRD principles compliance, and overall quality rating.
...
**Load and execute Advanced Elicitation workflow:** {advancedElicitationTask}
...
**5. Top 3 Improvements:** Identify the 3 most impactful improvements to make this a great PRD
...
**Master Rule:** This evaluates the WHOLE document, not just components. Answers "Is this a good
PRD?" and "What would make it great?"
